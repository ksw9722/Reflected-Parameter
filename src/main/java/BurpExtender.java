...
public class BurpExtender extends AbstractTableModel implements IBurpExtender, ITab, IHttpListener, IMessageEditorController
{
    ...
    public Object getValueAt(int rowIndex, int columnIndex)
    {
        ...
        switch (columnIndex)
        {
            ...
            case 5:
                return reflectedEntry.content_type;
            default:
                return "";
        }
    }
    ...
    private static class ReflectedEntry
    {
        ...
        ReflectedEntry(IHttpRequestResponseWithMarkers requestResponse, URL url, String method, List<String[]> parameters, String tool, String content_type)
        {
